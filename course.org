...
**** Magit
     ...
     2. To use it you will have to create an init file.
...
***** Interactive
      ...
      #+begin_src python :session *testpy* :export code :results silent
        def myadd(a,b):
            return(a+b)
      #+end_src

      #+begin_src python :results output :exports both :session *testpy*
        print(myadd(3,4))
      #+end_src
...
**** Confirming You Can Write and Run a Python File :homework:
     ...
     9. Submit that for your homework *along* with your .py file.
** Session 4 Python 
*** Types
    - Integers
    - Doubles/Floats
